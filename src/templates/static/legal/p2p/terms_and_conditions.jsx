    ...
    <div id='p2p-tnc'>
        ...
        <ol>
            <li>{it.L('Ads')}
                <ol>
                    ...
                    <li>{it.L('You can post one or more ads on our platform that provides an alternative way for buying and selling Binary.com credit. We have the right to restrict the number of your ads or remove your ads for security reasons and reasons of suspected misconduct or fraudulent activity.')}</li>
                    <li>{it.L('When you post ads, it is recommended that you stay active and available to react to orders that are placed in response to your ads. If a dispute is initiated (see <a href="https://www.binary.com/en/terms-and-conditions.html#complaints">Complaints and disputes</a> for more information) in a transaction against an advertiser who has not been active and available for the duration of the transaction, the advertiser may be considered unresponsive and the dispute may be resolved against the advertiser.')}</li>
            ...
            <li>{it.L('Exchanges')}
                <ol>
                    ...
                    <li>{it.L('When you are selling Binary.com credits, it is your responsibility to check that you have received payment for the full amount and that it was made according to the instructions you have given to the buyer.')}</li>
        ...
        <ol>
            <li>{it.L('Dispute initiation')}
                <ol>
                    <li>{it.L('If you are in disagreement over a transaction, either you, the other party, or we can start a dispute until at most 30 days from the date of the transaction. Our support staff, whom you can reach by <a href="mailto:complaint@binary.com" target="_blank">complaints@binary.com</a>, facilitate reviewing and resolving the disputed transactions.')}</li>
        ...
        <ol>
            <li>{it.L('If any of the conditions below or any of the conditions for suspension or termination of services mentioned in our <a href="https://www.binary.com/en/terms-and-conditions.html#complaints">General terms of use</a> is true, we reserve the right to restrict, suspend, or terminate your use of P2P Cashier, which might include but not be limited to temporarily or permanently revoking your authorisation to post ads on the P2P Cashier platform:')}
                <ol>
