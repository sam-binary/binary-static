        ...
        <ol className='p2p-tnv__list'>
            ...
            <li>{it.L('Orders')}
                <ol>
                    ...
                    <li>{it.L('You understand that you need to stay active and responsive when you create an order or when an order is created in response to your advertisement. You also undertake to provide true and accurate information (including but not limited to confirmation of receiving funds) in each exchange in which you engage. If you do not follow either of these terms, we reserve the right to take actions against you, such as temporarily or permanently restricting your access to the service.')}</li>
                </ol>
            </li>
            <br />
            <li>{it.L('Exchanges')}
                <ol>
                    ...
                    <li>{it.L('When you are selling [_1] credits, it is your responsibility to check that you have received payment for the full amount and that it was made according to the instructions you have given to the buyer.', it.website_name)}</li>
